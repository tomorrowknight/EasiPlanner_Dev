...
<tr><td>Deliver Time</td><td><%=parseInt(obj.get("deliver_time"))>0 ? new Date((parseInt(obj.get("deliver_time")) + new Date().getTimezoneOffset() )*60000) : "This item has not been delivered" %></td></tr>
</table>
</script>
