...
class ParcelController extends BaseController {
	...
	public function actionMultipleDelete() {
		...
		Parcel::deleteAll(["in","id",$deleteIds]);
		return;
	...
	public function actionIndex() {
		if (empty ( $_GET )) {
			return $this->redirect ( [ 
					'index',
					"ParcelSearch[window_start]" => date ( "Y-m-d" ),
					"Parcel[window_start]" => date ( "Y-m-d" ) 
			] );
		}
	...
	public function actionExport() {
		...
		$csv = new parseCSV ();
		$keys = explode ( ",", "vehicle_id,identifier,address,postal,volume,service_time,phone,customer_name,window_start,window_end,seq,deliver_time,planned_deliver_time,lat,lng" );
